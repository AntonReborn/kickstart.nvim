...
```sh
# on Linux and Mac
git clone https://github.com/AntonReborn/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```


```
# on Windows (cmd)
git clone https://github.com/AntonReborn/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```

```
# on Windows (powershell)
git clone https://github.com/AntonReborn/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\ 
```
